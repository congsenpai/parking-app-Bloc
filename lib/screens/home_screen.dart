...
class HomeScreen extends StatefulWidget {
  const HomeScreen({super.key, required UserModel user});
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
              ...
              actions: [
                TextButton(
                  onPressed: () => print('Noooooooooo'),
                  // Trả về "false" nếu người dùng chọn "No"
                  child: Text('No'),
                ),
                TextButton(
                  onPressed: () async {
                    await Provider.of<UserProvider>(context, listen: false)
                        .logout();
                    SystemNavigator
                        .pop(); // Thoát khỏi ứng dụng nếu người dùng chọn "Yes"
                    Navigator.of(context).pop(
                        true); // Trả về "true" sau khi gọi SystemNavigator.pop()
                  },
                  child: Text('Yes'),
                ),
              ]);
                                ...
                                const Column(
                                  ...
                                  children: [
                                    Text(
                                      "Ha Gia",
                                      style:
                                          TextStyle(color: Color(0xFFFAF9F6)),
                                    ),
                                    Text(
                                      "Bao",
                                      style: TextStyle(
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              image: DecorationImage(
                                                ...
                                                fit: BoxFit
                                                    .cover, // Đặt chế độ hiển thị hình ảnh (cover, fill, contain, ...)
                                              ),
                                              color: Colors.blue,
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
            ...
            children: [
              ...
              TextButton(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.wallet,
                        size: Get.width / 15, color: Colors.blue),
                    // Giới hạn kích thước icon
                    Text(
                      "Wallet",
                      style: TextStyle(
