...
class ParkingBookingDetailScreen extends StatefulWidget {
  ...
  @override
  State<ParkingBookingDetailScreen> createState() =>
      _ParkingBookingDetailScreenState();
}

class _ParkingBookingDetailScreenState
    extends State<ParkingBookingDetailScreen> {
                                ...
                                TableRow(
                                  children: [
                                    Container(
                                      alignment: Alignment.center,
                                      child: DropdownButton<String>(
                                        value: SelecteVehicalLisence.isEmpty
                                            ? null
                                            : SelecteVehicalLisence,
                                        items:
                                            VehicalLisence.map((String value) {
                                          return DropdownMenuItem<String>(
                                            value: value,
                                            child: Text(value,
                                                style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          Table(
                            columnWidths: const {
                              0: FlexColumnWidth(),
                              // Cột đầu tiên sẽ tự động căn trái
                              1: FlexColumnWidth(),
                              // Cột thứ hai tự động căn phải
                            },
                            children: [
                              TableRow(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    padding: const EdgeInsets.all(8.0),
                                    child:
                                        Text("$PriceBySelect_car_or_moto VND"),
                                  ),
                                ],
                              ),
                              TableRow(
                    ...
                    Container(
                        ...
                        child: !widget.isMonthly ? TextButton(
                            onPressed: () {
                              ...
                              Timestamp timestampStart = Timestamp.fromDate(
                                  combineDateAndTime(
